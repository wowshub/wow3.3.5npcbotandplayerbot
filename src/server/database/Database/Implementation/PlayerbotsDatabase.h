...
typedef PreparedStatement<PlayerbotsDatabaseConnection> PlayerbotsDatabasePreparedStatement;
typedef SQLTransaction<PlayerbotsDatabaseConnection> PlayerbotsDatabaseTransaction;
